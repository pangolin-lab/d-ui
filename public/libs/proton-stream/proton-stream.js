 ...
 * https://github.com/sofanetwork/MinePool-Web3js
 *
 */
 function normalPool(o){
 	var r=0;do{var a=Math.round(normal({mean:o.mean,dev:o.dev}));if(a<o.pool.length&&a>=0)return o.pool[a];r++}while(r<100)}function randomNormal(o){if(o=Object.assign({mean:0,dev:1,pool:[]},o),Array.isArray(o.pool)&&o.pool.length>0)return normalPool(o);var r,a,n,e,l=o.mean,t=o.dev;do{r=(a=2*Math.random()-1)*a+(n=2*Math.random()-1)*n}while(r>=1);return e=a*Math.sqrt(-2*Math.log(r)/r),t*e+l}
...
function drawParticle(particle, canvas, ctx) {
  let tagId = PSOption.id ? PSOption.id : 'proton-stream';
  canvas = document.getElementById(tagId);
...
function startAnimation(id) {
  PSOption.id = id;
  const [canvas, ctx] = initializeCanvas(id);
